...
// Compares equality and type (strict equality)-- makes sure that the data types match too
console.log(b === c);
console.log(b !== c);
// not equal to ! ==
...
// Returns false
console.log(!expression2);
// example: current value in to do list: checked an item on  to  do list by accident, click it agian for not operator
